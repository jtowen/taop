...
$a_param_type = array("s", "s", "s", "s", "s", "s", "s", "s", "s", "i");
$data_for_bind=array_values($data);
$db->updateUser($data_for_bind, $a_param_type);
...
<form role="form-horizontal" id="myForm" name="myForm" action="user.php" method="post">
<fieldset>
